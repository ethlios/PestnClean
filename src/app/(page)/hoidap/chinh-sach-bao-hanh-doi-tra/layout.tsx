...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Chính sách bảo hành đổi trả - Pestnclean',
        description:
            'Đến với PestnClean chúng tôi, bạn sẽ được cung cấp dịch vụ vệ sinh và kiểm soát côn trùng uy tín hàng đầu Việt Nam.',
        images: [
            {
        ...
        type: 'website',
        locale: 'vi_VN',
        siteName: 'Chính sách bảo hành đổi trả Pestnclean',
        url: '/hoidap/chinh-sach-bao-hanh-doi-tra',
    },
    alternates: {
        canonical: `/hoidap/chinh-sach-bao-hanh-doi-tra`,
    },
};
